...
if(BUILD_SHARED_LIBS)
  set(SERIAL_LIB_TYPE SHARED)
else()
  set(SERIAL_LIB_TYPE STATIC)
endif()
message(STATUS "serial v${PROJECT_VERSION} ${SERIAL_LIB_TYPE} library")
...
add_library(libserialport_internal_options INTERFACE)
target_compile_features(libserialport_internal_options INTERFACE c_std_99)

if(WIN32)
  # Force standard C99 printf/scanf over legacy MSVCRT
  if(MINGW)
    target_compile_definitions(libserialport_internal_options INTERFACE __USE_MINGW_ANSI_STDIO=1)
  endif()
else()
  ...
  if((UNIX AND NOT APPLE) OR CMAKE_SYSTEM_NAME MATCHES "Linux|GNU")
    target_compile_definitions(libserialport_internal_options INTERFACE
      _GNU_SOURCE=1
      _TIME_BITS=64
...
if(MSVC)
  set(BSX_IS_MSVC_LIKE TRUE)
elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND CMAKE_CXX_COMPILER_FRONTEND_VARIANT STREQUAL "MSVC")
  set(BSX_IS_MSVC_LIKE TRUE)
else()
  set(BSX_IS_MSVC_LIKE FALSE)
endif()

if(BSX_IS_MSVC_LIKE)
  target_compile_options(libserialport_internal_options INTERFACE
